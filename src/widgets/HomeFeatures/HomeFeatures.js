    ...
    return (
        <section className='bg-[#EEF5F9] xl:pt-[128px] py-[50px] xl:py-[114px] overflow-x-hidden featuresection'>
            ...
            <div className="container containerWidth">
                <p className='!text-[16px] font-medium !xl-text-[18px]  tracking-[0.36px] leading-[110%] xl:leading-normal text-[#000]'>What make us different</p>
                ...
                <div className="flex mt-[22px] items-end justify-between flex-col xl:flex-row">
                    <div className=" w-full  xl:w-2/3 ">
                        <h2 className='font-normal leading-[110%] tracking-[0px] xl:tracking-[-2px] !text-[40px] xl:text-[60px] xxl:!text-[100px]'>
                            Sculpting a Legacy in <i className="font-serief">Fine Catering</i>
                        </h2>
                    </div>
                ...
                <div className="flex flex-wrap flex-1 xl:flex-nowrap  w-full xl:w-auto gap-y-8 mt-[34px] xl:mt-[60px] boxes lg:-mx-4 ">
                    {props.data.map((datas, index) => {
                        return (
                         
                                <CardComponent number={datas} key={index} />
